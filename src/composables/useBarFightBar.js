...
export function useBarFightBar() {
    ...
    const updateBarWidth = (progressBarRef, minibarWidth, isPlayer // true or false
    ) => {
        if (!progressBarRef)
            return;
